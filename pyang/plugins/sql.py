...
class SqlPlugin(plugin.PyangPlugin):
    ...
    def emit(self, ctx, modules, fd):
        ...
        self.sampledata = ctx.opts.sqlsample
        ...
        if self.verbose:
            print("Generated with --sql-ancestor-count =", self.ancestorcount,
                  "and --sql-sample-data:", self.sampledata)
        ...
        for ch in chs:
            ...
            if ch.keyword in ['container']:
                ...
                if self.sampledata:
                    ...
                    sqlinserttable += "\nINSERT INTO " + self.underscore(ch.arg, ancestors) + samplecols + ";\n"
                    cols, samplecols = self.process_columns(ch, childtables=children, keys=keys, ancestors=ancestors,
